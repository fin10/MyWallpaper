...
public final class LiveWallpaperService extends WallpaperService {
    ...
    private static void changeWallpaper(@NonNull Context context, final SurfaceHolder holder, int width, final int height, long id) {
    ...
    private class Engine extends WallpaperService.Engine {
        ...
        public void onSurfaceChanged(final SurfaceHolder holder, int format, int width, int height) {
            ...
            Log.d("enter");
            long id = PreferenceUtils.getCurrentWallpaper(getBaseContext());
            changeWallpaper(getBaseContext(), holder, width, height, id);
        }
        ...
        public void onWallpaperChanged(@NonNull WallpaperModel.SetAsWallpaperEvent event) {
            ...
            long id = PreferenceUtils.getCurrentWallpaper(getBaseContext());
            changeWallpaper(getBaseContext(), holder, frame.width(), frame.height(), id);
        }
    }
}
